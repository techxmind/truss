...
import (
	...
	helper "github.com/techxmind/truss/gengokit/gentesthelper"
...
func TestApplyServerTempl(t *testing.T) {
	...
	conf := gengokit.Config{
		GoPackage: "github.com/techxmind/truss/gengokit/general-service",
	...
	expected := `
		...
		import (
			...
			pb "github.com/techxmind/truss/gengokit/general-service"
		)
