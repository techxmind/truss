...
import (
	...
	"github.com/techxmind/truss/gengokit"
	templateFileAssets "github.com/techxmind/truss/gengokit/template"
	"github.com/techxmind/truss/svcdef"

	"github.com/techxmind/truss/gengokit/gentesthelper"
)
...
func TestApplyTemplateFromPath(t *testing.T) {
	const def = `
		...
		import "github.com/techxmind/truss/deftree/googlethirdparty/annotations.proto";
	...
	conf := gengokit.Config{
		GoPackage: "github.com/techxmind/truss",
		PBPackage: "github.com/techxmind/truss/gengokit/general-service",
	}
...
func TestAllTemplates(t *testing.T) {
	const goPackage = "github.com/techxmind/truss/gengokit"
	const goPBPackage = "github.com/techxmind/truss/gengokit/general-service"
	...
	conf := gengokit.Config{
		GoPackage: "github.com/techxmind/truss/gengokit",
		PBPackage: "github.com/techxmind/truss/gengokit/general-service",
	}
