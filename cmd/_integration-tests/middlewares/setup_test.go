...
import (
	...
	"github.com/techxmind/truss/cmd/_integration-tests/middlewares/middlewarestest-service/handlers"
	svc "github.com/techxmind/truss/cmd/_integration-tests/middlewares/middlewarestest-service/svc"
	pb "github.com/techxmind/truss/cmd/_integration-tests/middlewares/proto"
)
