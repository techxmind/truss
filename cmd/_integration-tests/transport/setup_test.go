...
import (
	...
	handler "github.com/techxmind/truss/cmd/_integration-tests/transport/transportpermutations-service/handlers"
	svc "github.com/techxmind/truss/cmd/_integration-tests/transport/transportpermutations-service/svc"
)
