...
gobindata:
	go generate github.com/techxmind/truss/gengokit/template

# Install truss
truss: gobindata
	go install -ldflags '-X "main.version=$(SHA)" -X "main.date=$(VERSION_DATE)"' github.com/techxmind/truss/cmd/truss
